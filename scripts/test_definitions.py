...
ANSWER_TYPES = [
    ...
    (
        "sotindriya", "patipuccha", "indriya",
        "กัน regression ของ `ORDER BY` ที่หายไปใน _listed_together — คำนี้โผล่ 178 ท่อน"
        " แต่เราดูแค่ 25 ท่อนแรก ถ้าไม่เรียง แต่ละอินสแตนซ์ได้คนละชุด เคยเป็น"
        " vibhajja ที่ local แต่ patipuccha บน prod ทั้งที่ข้อมูลเหมือนกันเป๊ะ",
    ),
    (
